package com.mateyinc.marko.matey.storage;
...
public class SecurePreferences {
    ...
    public void put(String key, String value) throws SecurePreferencesException {
        if (value == null) {
    ...
    public void putValues(ArrayList<KVPair> kvpairs) throws SecurePreferencesException {

        SharedPreferences.Editor editor = preferences.edit();
        for (KVPair pair : kvpairs) {
            if (pair.value == null) {
                preferences.edit().remove(toKey(pair.key)).commit();
            } else {
                String secureValueEncoded = encrypt(pair.value, writer);
                editor.putString(toKey(pair.key), secureValueEncoded);
            }
        }
