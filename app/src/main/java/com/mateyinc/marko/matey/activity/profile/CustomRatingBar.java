...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.rating_bar_item;
    private int mStarOffResource = R.drawable.rating_bar_item_empty;
    private int mStarHalfResource = R.drawable.rating_bar_item_empty;
