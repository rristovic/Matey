...
public class UrlData {
    ...
    public final static String FIRST_RUN_URL = "http://10.0.2.2/NotifindaAPI/web/index.php/api/user/firstRun/" +
            Build.BOARD + "/" + Build.BRAND + "/" + Build.DEVICE + "/" + Build.MODEL;
    public final static String REGISTER_URL = "http://10.0.2.2/NotifindaAPI/web/index.php/api/user/register";
    public final static String LOG_URL = "http://10.0.2.2/NotifindaAPI/web/index.php/api/user/login";
    public final static String LOG_OUT_URL = "http://10.0.2.2/NotifindaAPI/web/index.php/api/user/logout";
